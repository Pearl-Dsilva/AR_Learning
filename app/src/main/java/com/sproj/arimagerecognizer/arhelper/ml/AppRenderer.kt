...
import com.sproj.arimagerecognizer.arhelper.common.helpers.DisplayRotationHelper
import com.sproj.arimagerecognizer.arhelper.common.helpers.FirestoreHelper
import com.sproj.arimagerecognizer.arhelper.common.samplerender.SampleRender
import com.sproj.arimagerecognizer.arhelper.common.samplerender.arcore.BackgroundRenderer
import com.sproj.arimagerecognizer.arhelper.ml.classification.DetectedObjectResult
import com.sproj.arimagerecognizer.arhelper.ml.classification.MLKitObjectDetector
import com.sproj.arimagerecognizer.arhelper.ml.classification.ObjectDetector
import com.sproj.arimagerecognizer.arhelper.ml.render.LabelRender
...
//            Log.d(TAG, "bindView: label $firstLabel")
    ...
    var analysisResult: Pair<List<DetectedObjectResult>, List<Bitmap>>? = null
    ...
    override fun onDrawFrame(render: SampleRender) {
        ...
        if (scanButtonWasPressed) {
            ...
            if (cameraImage != null) {
                ...
                launch(Dispatchers.IO) {
                    ...
                    analysisResult = currentAnalyzer.analyze(cameraImage, imageRotation)
                    objectResults = analysisResult?.first
                    cameraImage.close()
                }
            }
        }
        ...
        if (objects != null) {
            ...
            // push the data to firebase on the IO Thread
            launch(Dispatchers.IO) {
                FirestoreHelper().sendLabelsToFirestore(analysisResult)
            }
