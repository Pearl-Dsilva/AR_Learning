...
public final class DisplayRotationHelper implements DisplayListener {
    ...
    public DisplayRotationHelper(Context context) {
        ...
        checkDepthSensorCapabilities(cameraManager);
    }
    ...
    public int getCameraSensorToDisplayRotation(String cameraId) {
        ...
        Log.d(TAG, "getCameraSensorToDisplayRotation: Camera: " + cameraId);
        try {
    ...
    public static void checkDepthSensorCapabilities(CameraManager cameraManager) {
        try {
                ...
                if (capabilities != null) {
                    for (int capability : capabilities) {
                        if (capability == CameraCharacteristics.REQUEST_AVAILABLE_CAPABILITIES_DEPTH_OUTPUT) {
                            // Depth sensor available on this camera
                            Log.d(TAG, "checkDepthSensorCapabilities: Camera ID " + cameraId + " has depth sensor.");
                        }else{
                            Log.d(TAG, "checkDepthSensorCapabilities: Camera ID " + cameraId + " does not have depth sensor.");
                        }
                    }
                }
            }
