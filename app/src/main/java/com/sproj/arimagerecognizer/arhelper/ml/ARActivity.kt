...
import com.sproj.arimagerecognizer.arhelper.common.helpers.FullScreenHelper
            ...
            session.configure(
                session.config.apply {
                    ...
                    if (session.isDepthModeSupported(Config.DepthMode.AUTOMATIC)) {
                        ...
                        Log.d(
                            TAG,
                            "Raw Depth Only: " + session.isDepthModeSupported(Config.DepthMode.RAW_DEPTH_ONLY)
                        )
                        Log.d(
                            TAG,
                            "Disabled: " + session.isDepthModeSupported(Config.DepthMode.DISABLED)
                        )
                    }
